...
// 5. Crear tarea
// ---------------------------------------------------------------------------
function crearTarea(core, acciones, { titulo, fecha = '', hora = '', aviso = null, columnaTareaId = null, personaId = null, empresaIds = [], obraIds = [], notaInicial = '', subtareasIniciales = [] }) {
...
// ---------------------------------------------------------------------------
function editarTarea(core, acciones, { hiloId, titulo, fecha, hora, aviso }) {
...
export const CATALOGO_ACCIONES = [
  ...
  {
    nombre: 'editarTarea',
    descripcion: 'Edita el título, fecha, hora y/o aviso de una tarea existente (solo los campos que se pasen).',
    parametros: {
      type: 'object',
      properties: {
        hiloId: { type: 'string' },
