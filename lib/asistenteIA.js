...
21. vincularEntidades: { origenes*: {tipo: "Persona"|"Empresa"|"Obra", nombre}[], destinos*: (mismo formato), nota? }
22. asignarEtiqueta: { entidadTipo* ("Persona"|"Empresa"|"Obra"), entidadNombres*: string[], nombreEtiqueta*, categoriaNombre? }
